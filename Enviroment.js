...
class Enviroment {
    constructor() {
        ...
        //general variables
        this.passengerMass = 70;
        this.equipmentMass = 60; // boat mass
        ...
        //water speed
        this.WaterVelocity = new Vector3(1, 0, 1);
    ...
    addToGui() {
        ...
        this.gui.add(this, "passengerMass").min(0).max(100000).step(1).name("passengerMass");
        this.gui.add(this, "equipmentMass").min(0).max(100000).step(1).name("equipmentMass");
        ...
        this.gui.add(this.velocity, 'x').min(0).max(100).step(1).name("water velocity x ");
        this.gui.add(this.velocity, 'y').min(0).max(100).step(1).name("water velocity y ");
        this.gui.add(this.velocity, 'z').min(0).max(100).step(1).name("water velocity z ");
